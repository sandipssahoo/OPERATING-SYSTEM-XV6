...
struct proc {
  ...
  int mlfq_level;           // current queue level
  int ticks_at_level;       // ticks at current level
  int ticks_per_level[4];   // Total no of ticks its  level
  int times_scheduled;      // number of times scheduled
  int syscalls_at_level;    // syscalls made at current level
